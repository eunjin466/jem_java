...
//	
	...
	int apple = applebox - 9;
	int orange = orangebox - 2;
	int 총과일갯수 = apple + orange; 
	
	System.out.println("총 사과갯수: " + apple);
	System.out.println("총 오렌지갯수: " + orange);
	System.out.println("총 과일갯수: " + 총과일갯수);
